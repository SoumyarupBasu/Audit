...
function Breadcrumbs({ onNavigate }) {
  return (
    <div className="crumbs">
      ...
      <span className="crumb-link" onClick={() => onNavigate('framework')}>Frameworks</span>
      <span className="sep">/</span>
...
export default function AIFrameworkExtractor({ onNavigate, onFrameworkCreated }) {
    ...
    <div className="layout-single">
      <main className="content">
        <header className="page-head framework-head">
          <div className="container head-grid">
            <div className="head-content">
              <div className="page-icon" style={{ background: 'linear-gradient(135deg, #8b5cf6, #6366f1)' }}>
                <span style={{ fontSize: '28px', color: 'white' }}>🤖</span>
              </div>
              <div>
                <div className="page-title">AI Framework Extractor</div>
                <div className="page-subtitle">Extract compliance controls from documents using AI</div>
              </div>
            </div>
        ...
        <div className="container framework-container">
          <div className="framework-grid" style={{ maxWidth: '800px', margin: '0 auto' }}>
                ...
                <div className="section-body">
                  {isProcessing && (
                    <div>
                      <div style={{ marginBottom: '12px', color: 'var(--text-secondary)' }}>
                        Extracting controls from your document... This may take a few minutes.
                      </div>
                      <div style={{ background: 'var(--bg-3)', borderRadius: '8px', overflow: 'hidden', height: '8px' }}>
                        <div
                          style={{
                  ...
                  {isCompleted && (
                    <div style={{ textAlign: 'center', padding: '24px' }}>
                      ...
                      <div style={{ fontSize: '20px', fontWeight: 600, marginBottom: '8px', color: '#10b981' }}>
                        Extraction Complete!
                      </div>
                      <div style={{ color: 'var(--text-secondary)', marginBottom: '16px' }}>
                        Successfully extracted <strong>{jobStatus.controlCount}</strong> controls from your document.
                      </div>
                  ...
                  {isFailed && (
                    <div style={{ textAlign: 'center', padding: '24px' }}>
                      <div style={{ fontSize: '48px', marginBottom: '16px' }}>❌</div>
                      <div style={{ fontSize: '20px', fontWeight: 600, marginBottom: '8px', color: '#ef4444' }}>
                        Extraction Failed
                      </div>
                      <div style={{ color: 'var(--text-secondary)', marginBottom: '16px' }}>
            ...
            {!isProcessing && !isCompleted && (
              <>
                <div className="section">
                  ...
                  <div className="section-body">
                    <div className="upload-hint" style={{ marginBottom: '16px' }}>
                      <span className="hint-icon">
                        <Icon name="info" size="18px" />
                      </span>
                      <span>Upload a compliance framework document and our AI will automatically extract all controls.</span>
                    </div>
                    ...
                    >
                      ...
                      {!file ? (
                        <>
                          ...
                          <div className="drop-title">Drop your compliance document here</div>
                ...
                <div className="framework-actions">
                  <div className="actions-left">
                    <button className="btn-secondary" type="button" onClick={() => onNavigate('framework')}>
                      ← Back to Frameworks
                    </button>
                  </div>
