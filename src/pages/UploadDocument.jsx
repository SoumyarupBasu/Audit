  ...
  return (
    <div className="stack gap-lg">
      <Section title="Document Files">
        <div className="hint">
          Upload one document file. Supported: PDF, DOC, DOCX, PNG, JPEG, GIF,
          MP3, MP4, AAC, OGG, AMR, 3GPP, MOV. Max: 50MB.
        </div>
        ...
        >
          ...
          <div className="drop-sub">
            ...
            image/png, image/jpeg, image/gif, audio/mpeg, audio/mp4, audio/aac,
            audio/ogg, audio/amr, video/mp4, video/3gpp, video/quicktime - Max
            size: 50MB
          </div>
          <input
            type="file"
        ...
        <div className="legend">
          <div>
            ...
            <span className="muted">
              PDF, DOC, DOCX, PNG, JPEG, GIF, MP3, MP4, AAC, OGG, AMR, 3GPP, MOV
            </span>
          </div>
          <div>
