...
const availableFrameworks = [
  ...
  },
  {
    ...
    color: "#9333ea",
    description: "AI-Processed Composite Security Framework",
  },
];
...
export default function CustomFrameworkBuilder() {
  ...
  return (
    <div className="custom-framework-modal" onClick={handleClose}>
      <div
        className="custom-framework-content"
            ...
            {totalCount === 0 ? (
              <div className="empty-state">
                ...
                <p className="empty-state-desc">
                  Start by selecting controls from a framework or add controls
                  from other frameworks below.
                </p>
              </div>
            ) : (
              Object.entries(groupedControls).map(
                ([fwId, { framework, controls }]) => (
                  <div key={fwId} className="framework-group">
                    <div className="framework-group-header">
                      <div className="framework-group-info">
                        ...
                        <div>
                          <div className="framework-group-name">
                            {framework.name}
                          </div>
                    ...
                    <div className="framework-controls-list">
                      {controls.map((control) => (
                        <div
                          key={`${fwId}-${control.id}`}
                          className="selected-control-item"
                        >
                          <div className="selected-control-info">
                            <div className="selected-control-header">
                              <span className="selected-control-id">
                                {control.id}
                              </span>
                              <h5 className="selected-control-title">
                                {control.title}
                              </h5>
                            </div>
                            <p className="selected-control-category">
                              {control.category}
                            </p>
                          </div>
                          <button
            ...
            {!showAddControls ? (
              ...
              <div className="framework-selector">
                <div className="framework-selector-header">
                  <h4 className="framework-selector-title">
                    Select a Framework to Add Controls
                  </h4>
                  <button
                    className="btn-cancel-add"
                    onClick={handleCancelAddControls}
                  >
                    <Icon name="close" size="16px" />
                    Cancel
                  </button>
                ...
                <p className="framework-selector-subtitle">
                  Click on a framework to navigate to its controls page and
                  ...
                  {availableFrameworks.map((fw) => (
                    ...
                    >
                      ...
                      <div className="framework-selector-info">
                        ...
                        <p className="framework-selector-desc">
                          {fw.description}
                        </p>
                      </div>
