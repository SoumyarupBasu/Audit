...
export default function Dashboard({ onNavigate, theme }) {
  ...
  const recentActivity = [
    {
      id: 1,
      type: "upload",
      message: "New document uploaded: Security Policy v2.3",
      time: "2 hours ago",
      user: "Sarah Chen",
    },
    {
      id: 2,
      type: "audit",
      message: "ISO 27001 Q4 Audit updated to 68% complete",
      time: "4 hours ago",
      user: "Mike Johnson",
    },
    {
      id: 3,
      type: "framework",
      message: 'Custom framework "Healthcare Security" created',
      time: "1 day ago",
      user: "Emma Wilson",
    },
    {
      id: 4,
      type: "compliance",
      message: "NIST compliance score improved to 87%",
      time: "1 day ago",
      user: "System",
    },
    {
  ...
  const upcomingDeadlines = [
    {
      task: "ISO 27001 Annual Review",
      date: "2025-11-15",
      daysLeft: 5,
      priority: "high",
    },
    {
      task: "GDPR Data Mapping Update",
      date: "2025-11-18",
      daysLeft: 8,
      priority: "medium",
    },
    {
      task: "SOX Controls Testing",
      date: "2025-11-22",
      daysLeft: 12,
      priority: "high",
    },
              ...
              <div key={audit.id} className="audit-item">
                ...
                <div className="audit-progress-section">
                  <div className="audit-progress-header">
                    ...
                    <span className="audit-progress-value">
                      {audit.progress}%
                    </span>
                  </div>
              ...
              <div key={index} className="compliance-item">
                <div className="compliance-header">
                  ...
                  <div className="compliance-score-container">
                    <div
                      className={`compliance-score score-${
                        framework.score >= 90
                          ? "high"
                          : framework.score >= 70
                          ? "medium"
                    ...
                    <div
                      className={`compliance-change change-${framework.trend}`}
                    >
                      {framework.trend === "up" && "↗"}
            ...
            {upcomingDeadlines.map((deadline, index) => (
              <div key={index} className="deadline-item">
                <div className="deadline-indicator">
                  <div
                    className={`deadline-days priority-${deadline.priority}`}
                  >
                    {deadline.daysLeft}
                  </div>
                ...
                <div
                  className={`deadline-priority priority-${deadline.priority}`}
                >
